...
// Copied from pages/coverage-console/components/PacingRail.jsx (not imported).
...
// points behind elapsed, matching the pacingOk rule in the metrics.
const DivisionPacingRail = ({ pace = 0, elapsed = 0, dayOfMonth, totalDays, pctFmt }) => {
  ...
  return (
    <div>
      <div className="flex items-baseline justify-between mb-2">
        <span className="text-[10px] font-mono text-gray-400 uppercase tracking-widest">Pacing rail</span>
...
export default DivisionPacingRail;
